        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <Link to="/" className="flex items-center gap-2">
              <motion.div
                className="bg-linear-to-tr from-pink-500 via-purple-500 to-blue-500 p-2 rounded-xl"
                animate={{
          ...
          >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {active && (
                      <motion.div
                        className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-pink-500 via-purple-500 to-blue-500 rounded-full"
            ...
            {user?.role === "admin" && (
              <motion.div variants={itemVariants}>
                <Link
                  to="/admin"
                  className="flex items-center gap-2 px-4 py-2 rounded-xl text-pink-400 hover:bg-pink-500/10 transition-all"
                >
                  <motion.div
          ...
          >
            {user ? (
              <>
                ...
                >
                  <motion.div
                    className="h-8 w-8 rounded-full bg-linear-to-tr from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold"
              ...
              <>
                ...
                >
                  <Link
                    to="/auth?signup=true"
                    className="bg-linear-to-r from-pink-500 via-purple-500 to-blue-500 px-4 py-2 rounded-xl text-white font-semibold flex items-center gap-2 hover:shadow-lg hover:shadow-purple-500/50 transition-all"
                  >
                    <motion.div
                      animate={{ rotate: 360 }}
